...
<!-- Navigation -->
    ...
    <li>  <a href="/fraction/product4" class="navbar-brand">Add Product</a></li>
     <li> <a href="/fraction/product6" class="navbar-brand">Update/Delete Product</a></li>
      <li><a href="/fraction/product5" class="navbar-brand">List Products</a></li></ul>
    </div>   -->
			  ...
			  <a class="nav navbar-nav navbar-brand" href="/fraction/list_products/products">Products</a>
