...
public class UserController {
	...
	public String showUpdatePage(@RequestParam("username")String username,@RequestParam("password")String password,
			@RequestParam("confirmpassword")String confirmpassword)
	{
		UserDetails user2=udao.getuser(username);
		user2.setPassword(confirmpassword);
	...
	@RequestParam("confirmpassword")String confirmpassword,@RequestParam("customerName")String customerName,
	@RequestParam("mobileno")String mobileno,@RequestParam("emailid")String emailid,@RequestParam("address")String address,
	@RequestParam("role")String role,Model m)
	{
	UserDetails dat=new UserDetails();
	dat.setUsername(username);
	dat.setPassword(password);
	dat.setConfirmPassword(confirmpassword);
