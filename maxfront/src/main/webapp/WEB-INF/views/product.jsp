...
<form:form class="form-horizontal" action="InsertProduction" modelAttribute="prod" enctype="multipart/form-data" method="post">
...
<div class="form-group">
<label class="control-label col-md-4" for="brandname">Enter Brand Name</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="control-label col-md-4" for="pimage">Product Image</label>
<div class="col-md-8">
